...
def boy_next_door(color_hair, color_eyes, color_t_shirt, size, sc, x0, y0):
    ...
    ang_rect2(sc, x1, y1, int(0.63 * size), int(0.034 * size), +72, 3, SKN)
    ang_rect2(sc, x1, y1, int(0.63 * size), int(0.034 * size), +72, 3, BLC, 1)
    ...
    ang_rect2(sc, x2, y2, int(0.63 * size), int(0.034 * size), -72, 2, SKN)
    ang_rect2(sc, x2, y2, int(0.63 * size), int(0.034 * size), -72, 2, BLC, 1)
    polygon(sc, color_t_shirt, A2)
    polygon(sc, BLC, A2, 1)
    circle(sc, SKN, [int(0.5 * size - 0.44 * size) + x0, int(0.5 * size - 0.3 * size) + y0], int(0.042 * size))
    circle(sc, BLC, [int(0.5 * size - 0.44 * size) + x0, int(0.5 * size - 0.3 * size) + y0], int(0.042 * size), 1)
    circle(sc, SKN, [int(0.5 * size + 0.44 * size) + x0, int(0.5 * size - 0.3 * size) + y0], int(0.042 * size))
    circle(sc, BLC, [int(0.5 * size + 0.44 * size) + x0, int(0.5 * size - 0.3 * size) + y0], int(0.042 * size), 1)
...
poster(screen, int(SIZE * 0.5), int(SIZE * 0.18), int(SIZE * 0.98), int(SIZE * 0.07), "Ёбаный рот", GRN, BLC)
